...
<div id="wrapper">
   <div class="main-form">
       <form action="/Farm-Chat/controllers/ChangeUsername.jsp" method="POST">
           <fieldset>
               <div class="text-center">
                   <span class="form-logo glyphicon glyphicon-user"></span>
               </div>
               <div class="form-body">
                   <h1 class="form-title text-center">Change Username</h1>
                   <div class="form-group">
                       <input class="form-control" type="text" id="email" name="newusername" placeholder="New Username">
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group text-center">
                       ...
                       <button class="btn btn-default btn-lg" style="margin-left: 57px" type="submit">Change Username</button>
                       </div>
               </div>
           </fieldset>
       </form>
