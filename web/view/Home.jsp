...
if(e.value=="no")e.value="yes";
    ...
    <br/><br/>
    <button style="margin-left: 130px; height:25px; width:80px"class="btn btn-default btn-lg text-left" type="button" onclick=window.location.href="/Farm-Chat/view/uiCamera.html">Photo</button> 
        <br/><br/>
    ...
    <br/> <br/> <br/><br/><br/><br/><br/> 
    <button style="margin-left: 130px; height:25px; width:80px"class="btn btn-default btn-lg text-left" type="button" onclick=window.location.href="/Farm-Chat/msg/Logout.jsp">Logout</button>
</body> 
</html> 
