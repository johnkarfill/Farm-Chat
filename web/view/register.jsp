...
<div id="wrapper">
   <div class="main-form">
       <form action="/pat/controllers/registration.jsp" method="POST">
           <fieldset>
               ...
               <div class="form-body">
                   ...
                   <div class="form-group text-center">
                       <button class="btn btn-default btn-lg text-right" type="button" onclick=window.location.href="/pat/index.html">Back</button>
